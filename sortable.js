/*! Sortable 1.10.1 - MIT | git://github.com/SortableJS/Sortable.git */ ! function (t, e) {
    ...
    return Rt.mount(new function () {
        ...
        function t() {
            this.defaults = {
                replaceClass: "sortable-replace-highlight"
            }
        }
        return t.prototype = {
            dragStart: function (t) {
            ...
            dragOverValid: function (t) {
                ...
                var e = t.completed,
                    ...
                    r = t.changed,
                    a = t.cancel;
                if (i.options.replace) {
                    
                    var l = this.sortable.el,
                        s = this.options;
                    if (n && n !== l) {
                        var c = Jt;
                        Jt = !1 !== o(n) ? (k(n, s.replaceClass, !0), n) : null, c && c !== Jt && k(c, s.replaceClass, !1)
                    }
                    r(), e(!0), a()
                }
            },
            drop: function (t) {
                var e = t.activeSortable,
                    ...
                    r = this.options;
                //t.dragEl.style.display = "none";
                Jt && k(Jt, r.replaceClass, !1), Jt && (r.replace || n && n.options.replace) && o !== Jt && (i.captureAnimationState(), i !== e && e.captureAnimationState(), function (t, e) {
                    var n, o, i = t.parentNode,
                        r = e.parentNode;
                    if (!i || !r || i.isEqualNode(e) || r.isEqualNode(t)) return;
                    n = F(t), o = F(e), i.isEqualNode(r) && n < o && o++;
                    i.insertBefore(e, i.children[n]), r.insertBefore(t, r.children[o]), i.removeChild(e)
                }(o, Jt), i.animateAll(), i !== e && e.animateAll())
            },
            nulling: function () {
                Jt = null
